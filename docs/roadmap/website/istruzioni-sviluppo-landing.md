...
- **Corpi minimi — scala derivata dalla landing archiviata** (decisione Roberto 2026-07-19, in produzione): i corpi del prototipo (8–12px) erano troppo leggeri; il pavimento è quello che funzionava nella landing dark (`apps/site/archivio/landing-arioso/landing.css`): **label mono ≥11px**, descrizioni card **14px** (desktop) / **≥11.5px** (mobile), body di sezione **16px**, titoli card serif **21px+**, voci palette **14.5/12.5px**. Il prototipo resta il riferimento per composizione e proporzioni, non per i px assoluti dei corpi piccoli.
