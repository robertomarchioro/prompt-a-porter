 ...
 *
 * Copia speculare di `apps/client/src/lib/commenti.ts` (il client non
 * dipende da questo package): la semantica, condivisa anche con Rust e Go
 * CLI, è verificata dalla fixture `fixtures/commenti-conformita.json`:
